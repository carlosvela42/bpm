...
<head>
    ...
    <script src="${rc.getContextPath()}/resources/js/lib/handlebars.min.js"></script>
...
<div class="info" style="display: none">
    <input id="data_baseUrl" type="text" value="${rc.getContextPath()}" />
        ...
        <#include "progress_component.ftl">
</body>
</html>
</#macro>
...
<#macro noFooterLayout title="" imageLink="" displayWorkspace=false contentFooter="" script="">
<!DOCTYPE html>
<html lang="en">
<head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
